...
(function() {
    ...
    var _0x6e75xc = function() {
            Planet['apply'](this, [1, 'textures/terra/land_ocean_ice_cloud_2048.jpg', 'textures/terra/earth_bump.jpg']);
            this['planetMesh']['material']['bumpScale'] = 0.05;
            this['planetMesh']['material']['specularMap'] = ThreeUtils['loadManager']['loadTexture']('textures/terra/earthspec1k.jpg');
    ...
    var _0x6e75xd = function() {
            Planet['apply'](this, [(3475 / 12742), 'textures/terra/moonmap2k.jpg', 'textures/terra/moonbump2k.jpg', {
                x: 38
            }]);
    ...
    var _0x6e75xe = function() {
            ...
            var _0x6e75x10 = (_0x6e75xf) ? 'textures/terra/starField_small.jpg' : 'textures/terra/starField.jpg';
...
(function() {
    ...
    _0x6e75x2['showPhotorealistic'] = function() {
        ...
        this['reset']();
        if (!this['photorealisticMap']) {
            this['photorealisticMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showTerrain'] = function() {
        ...
        this['reset']();
        if (!this['terrainMap']) {
            this['terrainMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showTectonics'] = function() {
        ...
        if (!this['tectonicsMap']) {
            this['tectonicsMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
        this['earth']['planetMesh']['material']['map'] = this['tectonicsMap'];
        this['earth']['planetMesh']['material']['bumpMap'] = ThreeUtils['loadManager']['loadTexture']('textures/terra/earth_tectonics_bump.png');
    ...
    _0x6e75x2['showPolitical'] = function() {
        ...
        if (!this['politicalMap']) {
            this['politicalMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showEarthByNight'] = function() {
        ...
        this['reset']();
        if (!this['nightMap']) {
            this['nightMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showAverageLandTemp'] = function() {
        ...
        if (!this['averageLandTempMap']) {
            this['averageLandTempMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showClimateZones'] = function() {
        ...
        if (!this['climateZonesMap']) {
            this['climateZonesMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showPopulationCartogram'] = function() {
        ...
        if (!this['populationCartogram']) {
            this['populationCartogram'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showEnergyConsumption'] = function() {
        ...
        if (!this['energyConsumptionMap']) {
            this['energyConsumptionMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showGDP'] = function() {
        ...
        this['reset']();
        if (!this['GDPMap']) {
            this['GDPMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showPopulationDensity'] = function() {
        ...
        if (!this['populationDensityMap']) {
            this['populationDensityMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showPopulationGrowth'] = function() {
        ...
        if (!this['populationGrowthMap']) {
            this['populationGrowthMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showFertilityRate'] = function() {
        ...
        if (!this['fertilityRateMap']) {
            this['fertilityRateMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showPrecipitation'] = function() {
        ...
        if (!this['precipitationMap']) {
            this['precipitationMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
    ...
    _0x6e75x2['showGINI'] = function() {
        ...
        this['reset']();
        if (!this['GINIMap']) {
            this['GINIMap'] = this['loadTexture']('textures/terra/' + window['StateTextureMapper'][this['strState']])
        };
